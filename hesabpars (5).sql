...
INSERT INTO `currencies` (`id`, `code`, `name`, `symbol`, `exchange_rate`, `active`, `created_at`, `updated_at`) VALUES
(1, 'IRR', 'ریال', '﷼', 1.000000, 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58'),
(2, 'USD', 'دلار', '$', 1.000000, 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58'),
(3, 'EUR', 'یورو', '€', 1.000000, 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58');
...
INSERT INTO `tax_types` (`id`, `name`, `rate`, `description`, `active`, `created_at`, `updated_at`) VALUES
(1, 'مالیات بر ارزش افزوده', 9.00, 'مالیات بر ارزش افزوده استاندارد', 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58'),
(2, 'معاف از مالیات', 0.00, 'کالاها و خدمات معاف از مالیات', 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58');

-- --------------------------------------------------------

--
-- Table structure for table `tax_units`
--
...
--
-- Dumping data for table `tax_units`
--

INSERT INTO `tax_units` (`id`, `name`, `code`, `description`, `active`, `created_at`, `updated_at`) VALUES
(1, 'واحد پایه', 'BASE', 'واحد مالیاتی پایه', 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58'),
(2, 'معاف', 'EXEMPT', 'معاف از مالیات', 1, '2025-05-01 13:50:58', '2025-05-01 13:50:58');
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `full_name`, `phone`, `company_name`, `role`, `status`, `created_at`, `updated_at`, `last_login`) VALUES
(1, 'akradim', 'akradim@gmail.com', '$2y$10$JqpJhzNVkXor4j1mzHqZreWVlNHX7f3mJpqwyhtFab.Hru3YPMSRW', 'مصطفی اکرادی', NULL, NULL, 'user', 'active', '2025-04-30 11:53:31', '2025-04-30 11:53:31', NULL),
(2, 'admin', 'admin@hesabpars.ir', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدیر سیستم', NULL, NULL, '', 'active', '2025-04-30 23:54:52', '2025-04-30 23:54:52', NULL),
(4, 'akradim1', 'akradim@hotmail.com', '$2y$10$CHZFt3USghbIZhT9tMOiH.aik/O.mjJLiX4DxhFnWc0VevcT010n2', 'مصطفی اکرادی', NULL, NULL, 'user', 'active', '2025-05-01 17:06:17', '2025-05-01 17:41:22', '2025-05-01 17:41:22');
...
--
-- AUTO_INCREMENT for table `tax_units`
--
ALTER TABLE `tax_units`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
